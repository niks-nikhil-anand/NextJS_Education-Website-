      ...
      <div class="max-w-7xl mx-auto">
        ...
        <div class="grid lg:grid-cols-3 md:grid-cols-2 gap-12 max-md:max-w-lg mx-auto">
          <div class="rounded-xl group p-8 text-center bg-white text-purple-800 shadow-xl transition duration-300">
            ...
            <p class="text-gray-300 group-text-gray-500 text-sm">ICSE/CBSE</p>
          </div>
          <div class="rounded-xl group p-8 text-center bg-white text-purple-800 shadow-xl transition duration-300">
          ...
          <div class="rounded-xl group p-8 text-center bg-white text-purple-800 shadow-xl transition duration-300">
            ...
            <p class="text-gray-300 group-text-gray-500 text-sm"> ISC/CBSE</p>
          </div>
          <div class="rounded-xl group p-8 text-center bg-white text-purple-800 shadow-xl transition duration-300">
          ...
          <div class="rounded-xl group p-8 text-center bg-white text-purple-800 shadow-xl transition duration-300">
            ...
            <p class="text-gray-300 group-text-gray-500 text-sm">Expand your reach with our global network.</p>
          </div>
          <div class="rounded-xl group p-8 text-center bg-white text-purple-800 shadow-xl transition duration-300">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-8 mb-4 inline-block" viewBox="0 0 682.667 682.667">
              <defs>
            ...
            <p class="text-gray-300 group-text-gray-500 text-sm">Seamless communication for your team.</p>
          </div>
        </div>
      </div>
    </div>

  ...
  return (
    <div>
      ...
      <div class="max-w-7xl mx-auto">
        <h2 class="lg:text-4xl text-xl font-extrabold text-center mb-16">   JOIN OUR INTERACTIVE LIVE CLASSES</h2>
        <div class="grid lg:grid-cols-3 md:grid-cols-2 gap-12 max-md:max-w-lg mx-auto">
          <div class="rounded-xl group p-8 text-center hover:bg-white hover:text-purple-800 hover:shadow-xl transition duration-300">
            ...
            <h3 class="text-xl font-semibold mb-2"> Class - 9th </h3>
            <p class="text-gray-300 group-hover:text-gray-500 text-sm">ICSE/CBSE</p>
          </div>
          <div class="rounded-xl group p-8 text-center hover:bg-white hover:text-purple-800 hover:shadow-xl transition duration-300">
            ...
            <h3 class="text-xl font-semibold mb-2">Class-10th </h3>
            <p class="text-gray-300 group-hover:text-gray-500 text-sm">ICSE/CBSE</p>
          </div>
          <div class="rounded-xl group p-8 text-center hover:bg-white hover:text-purple-800 hover:shadow-xl transition duration-300">
            ...
            <h3 class="text-xl font-semibold mb-2">Class-11th (Commerce)</h3>
            <p class="text-gray-300 group-hover:text-gray-500 text-sm"> ISC/CBSE</p>
          </div>
          <div class="rounded-xl group p-8 text-center hover:bg-white hover:text-purple-800 hover:shadow-xl transition duration-300">
            ...
            <h3 class="text-xl font-semibold mb-2">Class-12th (Commerce)</h3>
            <p class="text-gray-300 group-hover:text-gray-500 text-sm"> ISC/CBSE </p>
          </div>
          <div class="rounded-xl group p-8 text-center hover:bg-white hover:text-purple-800 hover:shadow-xl transition duration-300">
            ...
            <h3 class="text-xl font-semibold mb-2">Digital Marketing Training </h3>
            <p class="text-gray-300 group-hover:text-gray-500 text-sm">Expand your reach with our global network.</p>
          </div>
          <div class="rounded-xl group p-8 text-center hover:bg-white hover:text-purple-800 hover:shadow-xl transition duration-300">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-8 mb-4 inline-block" viewBox="0 0 682.667 682.667">
              <defs>
            ...
            <h3 class="text-xl font-semibold mb-2">Personality development course</h3>
            <p class="text-gray-300 group-hover:text-gray-500 text-sm">Seamless communication for your team.</p>
          </div>
        </div>
      </div>
    </div>

      ...
      <div className="mx-auto max-w-7xl py-24 sm:px-6 sm:py-32 lg:px-8">
        <div className="relative isolate overflow-hidden bg-gray-800 px-6 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
          ...
          <div className="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
            ...
            DOWNLOAD OUR CRANAX 
              <br />
              GURUKUL LEARNING APP
            </h2>
            <p className="mt-6 text-lg leading-8 text-gray-300">
            Enroll in our live digital marketing training for expert guidance and placement opportunities. Learn directly from industry professionals to gain practical skills and advance your career in digital marketing.
